...
<table>
  ...
  <tr>
    <td class="robot-col">通用工具</td>
    <td><a href="https://github.com/Vulcan-YJX/horddt_cv">HORDDT CV</a></td>
    <td>基于 D-Robotics multimedia SDK 的 C++ 图像处理工具库，提供硬件缩放、裁剪、画中画、旋转、畸变矫正和编解码能力。</td>
