...
|20250611|Add [TITA app](https://github.com/DirectDriveTech-DDT/tita-app) based on Bluetooth on TITA|
...
|[TITA app](https://github.com/DirectDriveTech-DDT/tita-app)|A TITA apk used on Android, allows to control TITA on your Android smartphone.|
> Note : TITA can directly control the motor's torque through the ros2 control interface, or USB2CAN. If help is needed leave issue or contact our FAE.
#### DIABLO
| Title        | Descroption   |
| --------   |:----- | 
